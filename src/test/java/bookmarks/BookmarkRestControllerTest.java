...
public class BookmarkRestControllerTest {
    ...
    public void readSingleBookmark() throws Exception {
        mockMvc.perform(get("/" + userName + "/bookmarks/"
                ...
                .andExpect(jsonPath("$.links[0].href", is("http://bookmark.com/1/" + userName)))
                .andExpect(jsonPath("$.links[0].rel", is("bookmark-uri")))

                .andExpect(jsonPath("$.links[1].href", is("http://localhost/" + userName + "/bookmarks")))
                .andExpect(jsonPath("$.links[1].rel", is("bookmarks")))
                
                .andExpect(jsonPath("$.links[2].href", is("http://localhost/" + userName + "/bookmarks/" + this.bookmarkList.get(0).getId().intValue())))
